# [보존] grooman 자율빌드 스펙 (구 CLAUDE.md)

> 방법론 적용(2026-07-21) 전 grooman 루트에 있던 자율 빌드용 CLAUDE.md 원문.
> 방법론 거버넌스 CLAUDE.md가 루트를 차지하면서 이곳으로 이관해 보존함.
> 빌드 체크리스트·자율빌드 프로토콜 참고용. 라이브 규칙 아님.
