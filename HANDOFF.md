...
- Working on: GRM-010 정책 결정 완료(봇=테스트 픽스처, 배포 전 삭제). teardown 수단 구현이 다음
- Current mode: fullstack
- Next TODO: GRM-010 실행(is_bot 마커+teardown 스크립트+릴리스 게이트) / GRM-001 Lighthouse 감사
- Blockers: 없음
...
|----|-------|----------|-----------|
| BOT-1 | 봇 teardown 불가 — `is_bot` 컬럼 없음, 식별자 3곳 불일치(@grooman.kr/@grooman.internal/랜덤), 삭제 스크립트 부재 | **High** | GRM-010: is_bot 마커 + teardown 스크립트 + "봇 0건" 릴리스 게이트 |
